        ...
        >
          ...
          <div className="text-center mb-12">
            ...
            >
              ...
              <span className="text-white font-semibold text-lg">Professional Transport Services</span>
          ...
          <div className="text-center mb-16">
            ...
            >
              ...
              materials, our secure transfer services ensure safe delivery every time with uncompromising security standards.
            </motion.p>
          </div>
...
export default SecureTransferCTA;