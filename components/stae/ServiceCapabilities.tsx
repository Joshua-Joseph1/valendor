...
const SecureTransferCapabilities = () => {
  ...
  return (
    <section ref={capabilitiesRef} className="py-32 bg-gradient-to-br from-gray-50 via-slate-50 to-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          <div className="inline-flex items-center bg-valentor-red/10 backdrop-blur-sm rounded-full px-6 py-3 mb-8">
            ...
            <span className="text-valentor-red font-semibold text-sm uppercase tracking-wider">Advanced Capabilities</span>
          </div>
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            State-of-the-art resources and capabilities that ensure secure, efficient, 
            and reliable transport operations in any environment with cutting-edge technology.
          </p>
        </motion.div>
        ...
        >
          <div className="inline-flex items-center bg-white/80 backdrop-blur-xl rounded-full px-8 py-4 border border-gray-200 shadow-lg">
            ...
            <span className="text-gray-900 font-semibold">State-of-the-Art Equipment • Professional Excellence</span>
          </div>
        </motion.div>
      </div>
    </section>
