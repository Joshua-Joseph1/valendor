...
const SecureTransferStatistics = () => {
  const statistics = [
    {
      number: '5000+',
      label: 'Successful Transports',
      description: 'Completed missions worldwide'
    },
    {
      number: '100%',
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          <div className="inline-flex items-center bg-white/10 backdrop-blur-xl rounded-full px-6 py-3 border border-white/20 mb-8">
            ...
            <span className="text-white font-semibold text-sm uppercase tracking-wider">Performance Metrics</span>
          </div>
          ...
          <p className="text-xl md:text-2xl max-w-4xl mx-auto leading-relaxed text-white/90">
            ...
            of missions across the globe with zero security incidents, establishing us as the industry leader.
          </p>
        </motion.div>
        ...
        >
          <div className="inline-flex items-center bg-white/10 backdrop-blur-xl rounded-full px-8 py-4 border border-white/20">
            ...
            <span className="text-white font-semibold">Proven Excellence • Trusted Results</span>
          </div>
        </motion.div>
      </div>
    </section>
...
export default SecureTransferStatistics;