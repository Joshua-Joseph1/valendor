      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          <div className="inline-flex items-center bg-valentor-red/10 backdrop-blur-sm rounded-full px-6 py-3 mb-8">
            ...
            <span className="text-valentor-red font-semibold text-sm uppercase tracking-wider">Premium Technology Solutions</span>
          </div>
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            ...
            and digital protection systems for maximum security effectiveness with cutting-edge innovation.
          </p>
        </motion.div>
