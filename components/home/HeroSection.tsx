...
const HeroSection = ({ onScrollToServices }: HeroSectionProps) => {
  ...
  return (
    <section
      ref={heroRef}
      className="relative min-h-screen flex items-center text-white overflow-hidden pt-24 sm:pt-12 bg-[url('/images/hero-mobile.jpg')] sm:bg-[url('/images/hero-ipad.jpg')] md:bg-[url('/images/hero-image-4.jpg')] bg-cover bg-no-repeat bg-center"
    >
