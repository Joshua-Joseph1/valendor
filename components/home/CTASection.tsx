        ...
        >
          ...
          <div className="text-center mb-12">
            ...
            >
              ...
              <span className="text-white font-semibold text-lg">Elite Security Consultancy</span>
          ...
          <div className="text-center mb-16">
            ...
            >
              ...
              Valentor Group with their most critical security needs. Experience the difference 
              that true expertise and unwavering commitment make.
            </motion.p>
          </div>
