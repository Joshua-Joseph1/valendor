...
const AboutStory = () => {
  ...
  return (
    <section ref={storyRef} className="py-16 sm:py-20 lg:py-32 bg-white relative overflow-hidden">
      {/* Background elements */}
            ...
            <div className="bg-gradient-to-br from-valentor-red/5 via-red-50 to-slate-50 rounded-3xl p-6 sm:p-8 lg:p-10 shadow-2xl border border-valentor-red/10">
              <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-xl">
                ...
                <div className="flex items-center space-x-4 p-4 bg-gray-50 rounded-xl">
                  ...
                  <div>
                    <p className="font-semibold text-gray-900 text-sm sm:text-base">Excellence in Security</p>
                    <p className="text-xs sm:text-sm text-gray-600">Recognized industry leader</p>
                  </div>
                </div>
