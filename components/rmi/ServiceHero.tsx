...
const ServiceHero = ({
  ...
  return (
    <section 
      ref={heroRef}
      className={`relative py-32 bg-gradient-to-br from-${gradientFrom} via-slate-800 to-${gradientTo} text-white overflow-hidden`}
    >
      ...
      <div className="absolute inset-0">
        ...
        {/* Gradient overlay */}
        <div className={`absolute inset-0 bg-gradient-to-r from-${accentColor}/10 via-transparent to-slate-800/20`} />
      </div>
          ...
          <div className="text-center space-y-8">
            ...
            >
              ...
              <h1 className="text-4xl sm:text-6xl lg:text-7xl font-bold leading-tight">
                ...
                <span className={`block bg-gradient-to-r from-${accentColor} to-red-600 bg-clip-text text-transparent`}>
                  {subtitle}
                </span>
              </h1>
            </motion.div>
            ...
            >
              ...
              <div className={`w-24 h-1 bg-gradient-to-r from-${accentColor} to-red-600 rounded-full mx-auto`}></div>
            </motion.div>
            ...
            >
              <Button 
                size="lg" 
                className={`bg-${accentColor} hover:bg-red-700 text-white px-8 py-4 text-lg rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-105 group`}
