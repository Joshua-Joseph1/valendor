                ...
                >
                  <AccordionTrigger className="px-8 py-6 hover:no-underline group-hover:bg-gray-50/50 transition-all duration-300">
                    <div className="flex items-center text-left w-full">
                      <div className={`bg-gradient-to-br from-${accentColor}/20 to-${accentColor}/10 rounded-2xl p-4 mr-6 group-hover:from-${accentColor}/30 group-hover:to-${accentColor}/20 transition-all duration-300`}>
                        {offering.icon ? (
