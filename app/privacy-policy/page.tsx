    ...
    <div className="min-h-screen pt-20 bg-[#1a1a1a] text-white">
      ...
      <section className="py-20 bg-[#1a1a1a]">
        <div className="container mx-auto px-6">
          ...
          >
            <div className="bg-[#252525] border border-gray-700 rounded-2xl p-8 mb-12">
      ...
      <section ref={contentRef} className="py-20 bg-[#1a1a1a]">
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {sections.map((section, index) => (
                ...
                >
                  <Card className="h-full bg-[#252525] border border-gray-700 hover:shadow-lg transition-shadow duration-300">
